...
public class SalmonPlayer {
    ...
    public static SampleList timerCSampleList = new SampleList();
    ...
    /* ----- Tick(Player) -----*/
    public int collidingHorizontallyTick = 0, collidingVerticallyUpTick = 0, hungryTick = 0, itemChangeTick = 0, jumpTick = 0, placeBlockTick = 0, teleportTick = 0, respawnTick = 0, setBackTick = 0, swingTick = 0;
